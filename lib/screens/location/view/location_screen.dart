                ...
                children: [
                  Padding(
                    ...
                    child: GestureDetector(
                      ...
                      child: Image.asset(crossIcon, height: 20.h, width: 20.w),
                    ),
                  ),
                    ...
                    builder: (context, state) {
                      return Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: SearchBar(
                            controller:
                                context.read<LocationCubit>().searchController,
                            onSubmitted: (value) {
                              if (value.isNotEmpty) {
                                context.read<LocationCubit>().addSearch(value);
                                context
                                    .read<LocationCubit>()
                                    .searchController
                                    .clear();
                  ...
                  BlocBuilder<LocationCubit, LocationState>(
                    builder: (context, state) {
                      ...
                      return SizedBox(); // No suggestions
                    },
                  ),
                ],
              ),
